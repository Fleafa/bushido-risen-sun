...
- declare a Stand Up action, or an action that allows them to move into [BtB](Rulebook/definitions/terms_concepts/Base-to-Base.md) with one of those models, and move directly toward the Enemy model until they reach BtB, or
